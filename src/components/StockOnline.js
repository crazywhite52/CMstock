...
class StockOnline extends React.Component {
  ...
  response = () => {
    ...
    const list = data.StockApicommart[0].filter(item => item.alocateid2 == 'ONLINE');
  ...
  uporganize(e) {
    if (this.state.code === "") {
      ...
      var data = { orderid: e, userorganizer: this.state.code, itecuser: dc,alocateid:this.state.alocateid };
      //alert(data);
              ...
              <TableBody>
                {this.state.list.map(post => (
                  ...
                  <tr key={post.orderid} style={bgtd3}>
                   ...
                   <div style={bage}>
                  <Badge color={post.waittime <= "00:15:00" ? 'success': 'danger'} pill><b style={fontZ}>{post.waittime}</b></Badge>
                  </div>
                  </td>
                    {post.payq > 0 ? (
                    ...
                    <td className="text-center">
                      ...
                      <span><img src={pay} width={25} alt="Logo" /> <b style={post.pay===0? p1:p2}>{post.pay===0?'ยังไม่จ่าย':'จ่ายแล้ว'}</b></span>
                    </td>
                    <td className="text-center">
                      <MDBBtn
                        color="primary"
                        size="md"
                        onClick={() => this.toggle(post.orderid,post.alocateid2)}
                      >
                        <Fa icon="fa fa-address-book-o" /> จัด
                      </MDBBtn>
                      {/* <MDBBtn size="md" className="btn btn-dark-green" onClick={() => this.toggle(post.orderid)}><Fa icon="fa fa-address-book-o" /> จัด</MDBBtn> */}
                      <Modal
                      ...
                      >
                        <div className="modal-header primary-color white-text">
                          <h4 className="title">
                            <Fa className="fa fa-pencil" /> ผู้จัดสินค้า
                          </h4>
                          <button
                            type="button"
                            className="close"
                        ...
                        <ModalBody className="grey-text">
                          <p className="red-text">{this.state.inputcode}</p>
                          <Input
                            maxLength={6}
                            size="sm"
                          ...
                          <FormInline style={colorf}>
                            ...
                            <Input
                              ...
                              checked={this.state.radio3 === 2 ? true : false}
                              label="ช่อง 2"
                              type="radio"
                              id="radio2"
                            />
                            <Input
                              ...
                              checked={this.state.radio3 === 3 ? true : false}
                              label="ช่อง 3"
                              type="radio"
                              id="radio3"
                            />
                            <Input
                              ...
                              checked={this.state.radio3 === 4 ? true : false}
                              label="ช่อง 4"
                              type="radio"
                              id="radio4"
                            />
                            <Input
                              ...
                              checked={this.state.radio3 === 5 ? true : false}
                              label="ช่อง 5"
                              type="radio"
                              id="radio5"
                            />
                            <Input
                              ...
                              checked={this.state.radio3 === 6 ? true : false}
                              label="ช่อง 6"
                              type="radio"
                              id="radio6"
                            />
                            ...
                            <Input
                              ...
                              checked={this.state.radio3 === 10 ? true : false}
                              label="ช่อง 10"
                              type="radio"
                              id="radio10"
                            />
                        ...
                        <ModalFooter>
                          ...
                          <Button
                            color="primary"
                            onClick={() => this.uporganize(this.state.userput)}
                          >
                            Save
                          </Button>
                        </ModalFooter>
                    ...
                    {post.stockprint > 0 ? (
                      <td className="text-center" style={bgprint}>
                        {post.stockprint > 0 ? (
                          <MDBBtn
                             onClick={() =>{if(post.alocateid2==="JIB"){
                                this.print("JIB"+post.orderid,post.alocateid)
                            }else if(post.alocateid2==="ONLINE"){
                      this.print("ONLINE"+post.orderid,post.alocateid)
                            }else{
                      this.print("PRE"+post.orderid,post.alocateid)
                            }}}
                    ...
                    <div style={{margin:'0px'}} style={{display:'none'}}>
                      ...
                      <div id="printarea">
                      <div align={'center'}>
                      <b style={{'font-size': '55px'}}>{this.state.print}</b>
                      <p style={{'margin-top':'0px'}}><Barcode value={this.state.print} /></p>
                      </div>
                      </div>
                    </div>
                  </tr>
